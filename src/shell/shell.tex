...
\subsection{Running Programs not in the PATH}
...
\subsection{The {\tt find} and {\tt locate} commands}
...
\subsection{Searching for text using {\tt grep}}
...
\subsection{kill}
% TODO - talk about pgrep | xargs kill and the dangers therein, if you want!
...
% Talk about how  [] is a shorthand for test.
...
% The | and ┬ and _ didn't work in verabtim. 
{\tt
...
\subsection{Run once {\tt at(1)} a certain time}
...
\subsection{{\tt chgrp} and {\tt chown}}
...
\section{The differences between shells (a short, incomplete history)}
% bash is not sh
